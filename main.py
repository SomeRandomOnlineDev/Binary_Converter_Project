...
drop = tk.OptionMenu(window, variable, *options)
...
btn_misc_convert = tk.Button(master=window, relief=tk.RIDGE, text='Convert it!', command=lambda: mode_execution())
btn_misc_convert.grid(row=1, column=1)
